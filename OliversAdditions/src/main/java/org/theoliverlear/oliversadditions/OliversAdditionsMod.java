...
@Mod("olivers_additions")
public class OliversAdditionsMod {
    public static final String MODID = "olivers_additions";
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, MODID);
    // Directly reference a log4j logger.
    private static final Logger LOGGER = LogManager.getLogger();
    @ObjectHolder("olivers_additions:tweezers")
    public static final Item TWEEZERS = new TweezersItem();
    static {
        ITEMS.register("tweezers", TweezersItem::new);
    }
    ...
    private void enqueueIMC(final InterModEnqueueEvent event) {
        ...
        InterModComms.sendTo("olivers_additions", "helloworld", () -> { LOGGER.info("Hello world from the MDK"); return "Hello world";});
    }
